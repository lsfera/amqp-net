...
{
    internal class ConnectionClosePayload : MethodFramePayload
    {
        ...
        internal ConnectionClosePayload(Int16 replyCode,
                                        String replyText,
                                        Int16 sourceClassId,
        ...
        internal static ConnectionClosePayload Parse(IByteBuffer buffer)
        {
            return new ConnectionClosePayload(Int16FieldValueCodec.Instance.Decode(buffer),
