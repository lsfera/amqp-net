...
{
    internal class QueueDeclarePayload : MethodFramePayload
    {
        ...
        internal QueueDeclarePayload(Int16 reserved1,
                                     String name,
                                     Boolean passive,
                                     Boolean durable,
                                     Boolean exclusive,
        ...
        internal static QueueDeclarePayload Parse(IByteBuffer buffer)
        {
            ...
            return new QueueDeclarePayload(reserved1,
                                           name,
                                           passive,
                                           durable,
                                           exclusive,
