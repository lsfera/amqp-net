...
{
    internal class BasicDeliver : MethodFramePayload
    {
        ...
        internal BasicDeliver(String consumerTag,
                              Int64 deliveryTag,
                              Boolean redelivered,
                              String exchange,
                              String routingKey)
        ...
        internal static BasicDeliver Parse(IByteBuffer buffer)
        {
            ...
            return new BasicDeliver(consumerTag,
                                    deliveryTag,
                                    redelivered,
                                    exchange,
                                    routingKey);
