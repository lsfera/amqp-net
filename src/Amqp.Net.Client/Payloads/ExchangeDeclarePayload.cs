...
{
    internal class ExchangeDeclarePayload : MethodFramePayload
    {
        ...
        internal ExchangeDeclarePayload(Int16 reserved1,
                                        String name,
                                        ExchangeType type,
                                        Boolean passive,
                                        Boolean durable,
        ...
        internal static ExchangeDeclarePayload Parse(IByteBuffer buffer)
        {
            ...
            return new ExchangeDeclarePayload(reserved1,
                                              name,
                                              type,
                                              passive,
                                              durable,
