...
{
    internal class ChannelOpenPayload : MethodFramePayload
    {
        ...
        internal ChannelOpenPayload(String reserved1 = "")
        {
            Reserved1 = reserved1;
        }

        internal static ChannelOpenPayload Parse(IByteBuffer buffer)
        {
            return new ChannelOpenPayload(ShortStringFieldValueCodec.Instance.Decode(buffer));
        }
