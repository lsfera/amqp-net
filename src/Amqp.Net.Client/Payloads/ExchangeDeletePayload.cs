...
{
    internal class ExchangeDeletePayload : MethodFramePayload
    {
        ...
        internal ExchangeDeletePayload(Int16 reserved1,
                                       String name,
                                       Boolean ifUnused,
                                       Boolean noWait)
        {
        ...
        internal static ExchangeDeletePayload Parse(IByteBuffer buffer)
        {
            ...
            return new ExchangeDeletePayload(reserved1,
                                             name,
                                             ifUnused,
                                             noWait);
        }
