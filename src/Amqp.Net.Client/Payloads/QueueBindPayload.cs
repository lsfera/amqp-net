...
{
    internal class QueueBindPayload : MethodFramePayload
    {
        ...
        internal QueueBindPayload(Int16 reserved1,
                                  String queueName,
                                  String exchangeName,
                                  String routingKey,
                                  Boolean noWait,
        ...
        internal static QueueBindPayload Parse(IByteBuffer buffer)
        {
            ...
            return new QueueBindPayload(reserved1,
                                        queueName,
                                        exchangeName,
                                        routingKey,
                                        noWait,
