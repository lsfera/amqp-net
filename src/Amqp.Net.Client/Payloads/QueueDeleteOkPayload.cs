...
{
    internal class QueueDeleteOkPayload : MethodFramePayload
    {
        ...
        internal static QueueDeleteOkPayload Parse(IByteBuffer buffer)
        {
            return new QueueDeleteOkPayload(Int32FieldValueCodec.Instance.Decode(buffer));
        }

        internal QueueDeleteOkPayload(Int32 messageCount)
        {
