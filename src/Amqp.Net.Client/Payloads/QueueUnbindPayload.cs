...
{
    internal class QueueUnbindPayload : MethodFramePayload
    {
        ...
        internal QueueUnbindPayload(Int16 reserved1,
                                    String queueName,
                                    String exchangeName,
                                    String routingKey,
        ...
        internal static QueueUnbindPayload Parse(IByteBuffer buffer)
        {
            ...
            return new QueueUnbindPayload(reserved1,
                                          queueName,
                                          exchangeName,
                                          routingKey,
                                          arguments);
