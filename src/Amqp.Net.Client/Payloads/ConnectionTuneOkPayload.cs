...
{
    internal class ConnectionTuneOkPayload : MethodFramePayload
    {
        ...
        internal static ConnectionTuneOkPayload Parse(IByteBuffer buffer)
        {
            return new ConnectionTuneOkPayload(Int16FieldValueCodec.Instance.Decode(buffer),
                                               Int32FieldValueCodec.Instance.Decode(buffer),
                                               Int16FieldValueCodec.Instance.Decode(buffer));
        }

        internal ConnectionTuneOkPayload(Int16 channelMax,
                                         Int32 frameMax,
                                         Int16 heartbeat)
        {
