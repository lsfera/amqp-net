...
{
    internal class ConnectionCloseOkPayload : MethodFramePayload
    {
        internal static readonly MethodFrameDescriptor StaticDescriptor = new MethodFrameDescriptor(10, 51);

        internal static ConnectionCloseOkPayload Parse(IByteBuffer buffer)
        {
            return new ConnectionCloseOkPayload();
        }
