...
{
    internal class BasicConsumePayload : MethodFramePayload
    {
        ...
        internal BasicConsumePayload(Int16 reserved1,
                                     String queueName,
                                     String consumerTag,
                                     Boolean noLocal,
                                     Boolean noAck,
        ...
        internal static BasicConsumePayload Parse(IByteBuffer buffer)
        {
            ...
            return new BasicConsumePayload(reserved1,
                                           queueName,
                                           consumerTag,
                                           noLocal,
                                           noAck,
