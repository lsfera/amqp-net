...
{
    internal class BasicQosPayload : MethodFramePayload
    {
        ...
        internal BasicQosPayload(Int32 prefetchSize,
                                 Int16 prefetchCount,
                                 Boolean global)
        {
        ...
        internal static BasicQosPayload Parse(IByteBuffer buffer)
        {
            ...
            return new BasicQosPayload(prefetchSize,
                                       prefetchCount,
                                       global);
        }
